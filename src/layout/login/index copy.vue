        ...
        <el-form :model="loginForm" ref="refLoginForm" :rules="rules" size="large">
          ...
          <!-- <el-form-item prop="code">
            <el-input v-model="loginForm.code" placeholder="请输入验证码" class="code">
              <template #prefix>
                <svg-icon size="25px" icon="captcha"></svg-icon>
              </template>
            </el-input>
            <img :src="imgBase" class="code-img" @click="refreshCode" />
          </el-form-item> -->
          <el-form-item>
            <el-button type="primary" size="large" @click="loginSubmit(refLoginForm)" :loading="loading" class="wid">
              登录
            </el-button>
          </el-form-item>
        </el-form>
